...
import { DATA_API_PREFIX, MESSAGING_API_PREFIX, OAUTH_BASE_PREFIX, OAUTH_BASE_PREFIX_V2_1, } from "./endpoints.js";
/**
...
export default class Client {
    ...
    async getBotFollowersIds() {
        ...
        let start;
        do {
            const res = await this.http.get(`${MESSAGING_API_PREFIX}/followers/ids`, start ? { start, limit: 1000 } : { limit: 1000 });
            ensureJSON(res);
