/**
 * @deprecated These URL prefix constants are used by the legacy `Client` class.
 * `LineBotClient` manages base URLs via `LineBotClientConfig` (`apiBaseURL`, `dataApiBaseURL`).
 */
export const MESSAGING_API_PREFIX = `https://api.line.me/v2/bot`;
/** @deprecated See `MESSAGING_API_PREFIX`. */
