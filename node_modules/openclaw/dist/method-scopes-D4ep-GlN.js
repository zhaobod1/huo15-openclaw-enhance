...
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-DnQkETjb.js";
...
import { n as resolveReservedGatewayMethodScope } from "./gateway-method-policy-B6PxpClk.js";
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-BZdSA8i7.js";
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-ho6SSF_R.js";
import { a as isSecureWebSocketUrl, r as isLoopbackHost } from "./net-DwNAtbJy.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-avMrHmZQ.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-SRMZ4WYD.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-oPOnTB4V.js";
import { t as normalizeFingerprint } from "./fingerprint-CSdEm0Hh.js";
import { t as rawDataToString } from "./ws-DLFbhvgw.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-D80eqq0Y.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-B5UbDNg3.js";
import { n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-B8HcVLe1.js";
...
//#endregion
export { validateExecApprovalResolveParams as $, validateWakeParams as $t, validateConfigApplyParams as A, validateSessionsCreateParams as At, validateCronRemoveParams as B, validateSessionsUsageParams as Bt, validateAgentsUpdateParams as C, validatePushTestParams as Ct, validateChatHistoryParams as D, validateSendParams as Dt, validateChatAbortParams as E, validateSecretsResolveResult as Et, validateConfigSchemaParams as F, validateSessionsPatchParams as Ft, validateDevicePairApproveParams as G, validateSkillsStatusParams as Gt, validateCronRunsParams as H, validateSkillsDetailParams as Ht, validateConfigSetParams as I, validateSessionsPreviewParams as It, validateDevicePairRemoveParams as J, validateTalkModeParams as Jt, validateDevicePairListParams as K, validateSkillsUpdateParams as Kt, validateConnectParams as L, validateSessionsResetParams as Lt, validateConfigPatchParams as M, validateSessionsListParams as Mt, validateConfigSchemaLookupParams as N, validateSessionsMessagesSubscribeParams as Nt, validateChatInjectParams as O, validateSessionsAbortParams as Ot, validateConfigSchemaLookupResult as P, validateSessionsMessagesUnsubscribeParams as Pt, validateExecApprovalRequestParams as Q, validateUpdateRunParams as Qt, validateCronAddParams as R, validateSessionsResolveParams as Rt, validateAgentsListParams as S, validatePollParams as St, validateChannelsStatusParams as T, validateSecretsResolveParams as Tt, validateCronStatusParams as U, validateSkillsInstallParams as Ut, validateCronRunParams as V, validateSkillsBinsParams as Vt, validateCronUpdateParams as W, validateSkillsSearchParams as Wt, validateDeviceTokenRotateParams as X, validateToolsCatalogParams as Xt, validateDeviceTokenRevokeParams as Y, validateTalkSpeakParams as Yt, validateExecApprovalGetParams as Z, validateToolsEffectiveParams as Zt, validateAgentsCreateParams as _, validateNodePendingDrainParams as _t, resolveLeastPrivilegeOperatorScopesForMethod as a, validateWizardStatusParams as an, validateModelsListParams as at, validateAgentsFilesListParams as b, validatePluginApprovalRequestParams as bt, PAIRING_SCOPE as c, parseSessionLabel as cn, validateNodeInvokeParams as ct, WRITE_SCOPE as d, resolveDeviceAuthConnectErrorDetailCode as dn, validateNodePairApproveParams as dt, validateWebLoginStartParams as en, validateExecApprovalsGetParams as et, GatewayClient as f, getPreauthHandshakeTimeoutMsFromEnv as fn, validateNodePairListParams as ft, validateAgentWaitParams as g, validateNodePendingAckParams as gt, validateAgentParams as h, validateNodePairVerifyParams as ht, isNodeRoleMethod as i, validateWizardStartParams as in, validateLogsTailParams as it, validateConfigGetParams as j, validateSessionsDeleteParams as jt, validateChatSendParams as k, validateSessionsCompactParams as kt, READ_SCOPE as l, ConnectErrorDetailCodes as ln, validateNodeInvokeResultParams as lt, validateAgentIdentityParams as m, buildDeviceAuthPayloadV3 as mn, validateNodePairRequestParams as mt, authorizeOperatorScopesForMethod as n, validateWizardCancelParams as nn, validateExecApprovalsNodeSetParams as nt, ADMIN_SCOPE as o, ErrorCodes as on, validateNodeDescribeParams as ot, formatValidationErrors as p, buildDeviceAuthPayload as pn, validateNodePairRejectParams as pt, validateDevicePairRejectParams as q, validateTalkConfigParams as qt, isAdminOnlyMethod as r, validateWizardNextParams as rn, validateExecApprovalsSetParams as rt, APPROVALS_SCOPE as s, errorShape as sn, validateNodeEventParams as st, CLI_DEFAULT_OPERATOR_SCOPES as t, validateWebLoginWaitParams as tn, validateExecApprovalsNodeGetParams as tt, TALK_SECRETS_SCOPE as u, resolveAuthConnectErrorDetailCode as un, validateNodeListParams as ut, validateAgentsDeleteParams as v, validateNodePendingEnqueueParams as vt, validateChannelsLogoutParams as w, validateRequestFrame as wt, validateAgentsFilesSetParams as x, validatePluginApprovalResolveParams as xt, validateAgentsFilesGetParams as y, validateNodeRenameParams as yt, validateCronListParams as z, validateSessionsSendParams as zt };
