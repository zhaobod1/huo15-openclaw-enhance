...
import { _ as loadBundleManifest, d as safeRealpathSync, o as discoverOpenClawPlugins, r as normalizeChatChannelId, s as resolvePluginCacheInputs, u as isPathInside } from "./ids-Dm8ff2qI.js";
...
const normalizeList = (value, normalizePluginId) => {
...
const normalizePluginEntries = (entries, normalizePluginId) => {
...
function resolveManifestContractOwnerPluginId(params) {
	...
	return loadPluginManifestRegistry({
		...
		workspaceDir: params.workspaceDir,
		env: params.env
	}).plugins.find((plugin) => (!params.origin || plugin.origin === params.origin) && listContractValues(plugin, params.contract).some((candidate) => candidate.trim().toLowerCase() === normalizedValue))?.id;
}
...
//#endregion
export { hasExplicitPluginConfig as a, resolveMemorySlotDecision as c, resolveManifestContractPluginIds as i, loadPluginManifestRegistry as n, normalizePluginsConfigWithResolver as o, resolveManifestContractOwnerPluginId as r, resolveEffectivePluginActivationState as s, clearPluginManifestRegistryCache as t };
