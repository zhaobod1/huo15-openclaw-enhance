...
import { a as guardCancel, c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, m as validateGatewayPasswordInput, n as applyWizardMetadata, p as summarizeExistingConfig, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-BWSZmief.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-xIdHYUqC.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-zeG28fl3.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-Da1NEVmB.js";
import { n as applyAuthChoice } from "./auth-choice-B7QMTffJ.js";
import { i as noteChannelStatus, o as shouldShowChannelInSetup, r as setupChannels } from "./onboard-channels-BhDh0eUz.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-DD_zjOPH.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-oHxf8mbV.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-JypxVGVc.js";
import { i as promptCustomApiConfig } from "./onboard-custom-BN3ONZFX.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-BP-G1XfM.js";
import { t as formatHealthCheckFailure } from "./health-format-Ck8ZwAhL.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-DgLVrLQ5.js";
import { t as setupSkills } from "./onboard-skills-BqZh6pBj.js";
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-NxCZuajc.js");
	...
	try {
		...
		if (opts.sections) {
			...
			if (selected.includes("plugins")) {
				const { configurePluginConfig } = await import("./setup.plugin-config-BneoIzgf.js");
