...
import { c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-BWSZmief.js";
...
import { i as resolveDeprecatedAuthChoiceReplacement, l as resolveManifestProviderOnboardAuthFlags, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DYXYTQpj.js";
import { t as runSetupWizard } from "./setup-CwPj_Gd-.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-CjshnWIE.js";
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-zWYR0LJH.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-BDGPlr4m.js");
