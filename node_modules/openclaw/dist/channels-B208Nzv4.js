...
import { r as listChannelPluginCatalogEntries } from "./catalog-B2BUSdhK.js";
import { t as createClackPrompter } from "./clack-prompter-B7M6AAE4.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BQHTliJu.js";
import { t as parseLogLine } from "./parse-log-line-CtAtDG5w.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-sIm2d_BY.js";
import { a as isCatalogChannelInstalled, n as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-BhDh0eUz.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-diiA6D7y.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-BlPdMeuD.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-DEdVHR1A.js"), import("./onboard-channels-CQxQx6PO.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-nJSqGTZF.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-nJSqGTZF.js");
			const prompter = createClackPrompter();
