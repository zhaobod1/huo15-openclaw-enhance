...
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-DqZbx7oj.js";
...
function loadMessageConfigRuntime() {
	messageConfigRuntimePromise ??= import("./message.config.runtime-DITf-Spe.js");
	return messageConfigRuntimePromise;
}
function loadMessageGatewayRuntime() {
	messageGatewayRuntimePromise ??= import("./message.gateway.runtime-BXaR6iyb.js");
