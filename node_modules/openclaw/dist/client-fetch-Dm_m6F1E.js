...
import { n as resolveBrowserControlAuth, t as ensureBrowserControlAuth } from "./control-auth-B1GhGLsH.js";
import "./browser-config-support-BDDkfL2E.js";
import "./browser-node-runtime-BWVBEZlG.js";
...
async function closePlaywrightBrowserConnectionForProfile$1(cdpUrl) {
	try {
		await (await import("./pw-ai-Vetr7oLS.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
	} catch {}
}
//#endregion
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Vetr7oLS.js");
	} catch (err) {
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-Vetr7oLS.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
