...
import { Dt as normalizeProviderSpecificConfig, Et as applyNativeStreamingUsageCompat, It as createConfigRuntimeEnv, Ot as resolveProviderConfigApiKeyResolver, a as loadConfig, s as projectConfigOntoRuntimeSourceSnapshot } from "./io-CS2J_l4V.js";
import { F as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-SgdEL2pb.js";
import { d as resolveSecretInputRef, i as coerceSecretRef } from "./types.secrets-BZdSA8i7.js";
import { i as getRuntimeConfigSourceSnapshot } from "./runtime-snapshot-BQtdTwL2.js";
import "./zod-schema-C3jh3SvI.js";
...
import "./facade-runtime-Bv3MxT2V.js";
import { h as resolveNonEnvSecretRefHeaderValueMarker, m as resolveNonEnvSecretRefApiKeyMarker, p as resolveEnvSecretRefHeaderValueMarker, u as isNonSecretApiKeyMarker } from "./model-auth-markers-DBBQxeVp.js";
import { o as resolveProviderWebSearchPluginConfig } from "./provider-web-search-D_E69gvc.js";
...
function resolveXaiConfigFallbackAuth(params) {
	...
	const legacyGrokApiKey = normalizeOptionalSecretInput((params.config?.tools?.web?.search)?.grok?.apiKey);
	if (legacyGrokApiKey) return {
		apiKey: legacyGrokApiKey,
		source: "tools.web.search.grok.apiKey",
		mode: "api-key"
	};
	const legacyGrokApiKeyRef = coerceSecretRef((params.config?.tools?.web?.search)?.grok?.apiKey);
	if (legacyGrokApiKeyRef) return {
		apiKey: legacyGrokApiKeyRef.source === "env" ? legacyGrokApiKeyRef.id.trim() : resolveNonEnvSecretRefApiKeyMarker(legacyGrokApiKeyRef.source),
		source: "tools.web.search.grok.apiKey",
		mode: "api-key"
	};
}
...
function resolveProviderDiscoveryFilter(env) {
