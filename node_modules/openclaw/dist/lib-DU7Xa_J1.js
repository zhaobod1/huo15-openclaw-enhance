...
import { t as require_src } from "./src-CqjL9Nwt.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-DKZgXK5b.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-D-fhdTGL.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-B3Ub3md_.js";
import { l as toRatio, n as decodeString } from "./Util-CqxqJHDY.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-GgmPSVeV.js";
import { t as APEv2Parser } from "./APEv2Parser-DkKGGyTJ.js";
import { r as hasID3v1Header } from "./ID3v1Parser-Dl4mn83i.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-Cg3g3Fhw.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-CM2hI4me.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DO7ntzJS.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DnO0CNxY.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-BSA1w6XM.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-Do0t0Y6G.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CLHbX3Yh.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-ChSp_i30.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CZDcYRZp.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DTsjtqga.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BOBX9QUy.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-BS2Z5k0D.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DbHwsV9N.js")).WaveParser;
	}
};
//#endregion
