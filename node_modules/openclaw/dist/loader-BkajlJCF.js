import { S as createEmptyPluginRegistry, d as recordImportedPluginId, i as getActivePluginRegistryKey, r as getActivePluginRegistry, y as setActivePluginRegistry } from "./runtime-Dji2WXDE.js";
import { i as openBoundaryFileSync, n as matchBoundaryFileOpenFailure } from "./boundary-file-read-CdxVvait.js";
import { l as isRecord, m as resolveUserPath, x as isPlainObject } from "./utils-ms6h9yny.js";
import { f as safeStatSync, h as CURSOR_BUNDLE_MANIFEST_RELATIVE_PATH, m as CODEX_BUNDLE_MANIFEST_RELATIVE_PATH, o as discoverOpenClawPlugins, p as CLAUDE_BUNDLE_MANIFEST_RELATIVE_PATH, s as resolvePluginCacheInputs, u as isPathInside, v as mergeBundlePathLists, y as normalizeBundlePathList } from "./ids-Dm8ff2qI.js";
...
import { i as kindsEqual, n as defaultSlotIdForKey, r as hasKind } from "./slots-C_o3k-JZ.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-Cqdpf6fh.js";
import { i as resolvePluginRuntimeModulePath, n as buildPluginLoaderJitiOptions, s as shouldPreferNativeJiti, t as buildPluginLoaderAliasMap } from "./sdk-alias-7jGsJqWE.js";
import { t as sanitizeTerminalText } from "./safe-text-CZwe1QN-.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, n as createPluginActivationSource, o as resolveEffectiveEnableState, s as resolveEffectivePluginActivationState, t as applyTestPluginDefaults } from "./config-state-CKMpUUgI.js";
...
import { a as isPluginHookName, d as validatePluginCommandDefinition, f as clearPluginCommands, l as registerPluginCommand, o as isPromptInjectionHookName, s as stripPromptMutationFieldsFromLegacyHookResult } from "./types-COS905i3.js";
import { i as initializeGlobalHookRunner } from "./hook-runner-global-Dd0oQ2OY.js";
import { n as resolveGlobalDedupeCache } from "./dedupe-CB5IJsQ1.js";
import { a as getMemoryRuntime, c as registerMemoryPromptSection, d as restoreMemoryPluginState, i as getMemoryPromptSectionBuilder, l as registerMemoryRuntime, n as clearMemoryPluginState, r as getMemoryFlushPlanResolver, s as registerMemoryFlushPlanResolver } from "./memory-state-BWbQIcQt.js";
import { n as registerContextEngineForOwner } from "./registry-BCBwbTTA.js";
import { f as registerInternalHook } from "./internal-hooks-CVt9m78W.js";
import { t as normalizePluginGatewayMethodScope } from "./gateway-method-policy-B6PxpClk.js";
import { a as normalizePluginHttpPath, t as findOverlappingPluginHttpRoute } from "./http-route-overlap-BBDTJzpq.js";
	...
	const registerNodeHostCommand = (record, nodeCommand) => {
		...
		registry.nodeHostCommands.push({
			...
			command: {
				...nodeCommand,
				command,
				cap: nodeCommand.cap?.trim() || void 0
			},
			source: record.source,
			rootDir: record.rootDir
		});
...
//#endregion
export { loadEnabledBundleMcpConfig as _, validateJsonSchemaValue as a, readBundleJsonObject as b, getPluginRuntimeGatewayRequestScope as c, NODE_EXEC_APPROVALS_COMMANDS as d, NODE_SYSTEM_NOTIFY_COMMAND as f, inspectBundleMcpRuntimeSupport as g, listRegisteredMemoryEmbeddingProviders as h, resolveRuntimePluginRegistry as i, withPluginRuntimeGatewayRequestScope as l, getRegisteredMemoryEmbeddingProvider as m, loadOpenClawPlugins as n, appendAllowedValuesHint as o, NODE_SYSTEM_RUN_COMMANDS as p, resolveCompatibleRuntimePluginRegistry as r, summarizeAllowedValues as s, loadOpenClawPluginCliRegistry as t, NODE_BROWSER_PROXY_COMMAND as u, inspectBundleServerRuntimeSupport as v, applyMergePatch as x, loadEnabledBundleConfig as y };
