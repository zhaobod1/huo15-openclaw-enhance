...
import "./api-lXPKYU0J.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-C-XCG1s_.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-lLmZxR8n.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-BPOuX7hl.js";
import { t as getHeader } from "./http-headers-D2fXQyhf.js";
...
var VoiceCallWebhookServer = class {
	...
	*/
	async initializeMediaStreaming() {
		...
		const { getRealtimeTranscriptionProvider, listRealtimeTranscriptionProviders } = await import("./realtime-transcription.runtime-DDyg7-o2.js");
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("./response-generator-B-MqXLyX.js");
...
async function resolveProvider(config) {
	...
	switch (config.provider) {
		case "telnyx": {
			const { TelnyxProvider } = await import("./telnyx-E5Cw51ti.js");
		...
		case "twilio": {
			const { TwilioProvider } = await import("./twilio-Dsx66ZyS.js");
		...
		case "plivo": {
			const { PlivoProvider } = await import("./plivo-BPaUMH10.js");
		...
		case "mock": {
			const { MockProvider } = await import("./mock-BSaKuY5M.js");
...
async function resolveRealtimeProvider(params) {
	const { getRealtimeVoiceProvider, listRealtimeVoiceProviders } = await import("./realtime-voice.runtime-dfwJWzjP.js");
	const resolution = resolveConfiguredCapabilityProvider({
...
async function createVoiceCallRuntime(params) {
	...
	if (realtimeProvider) {
		const { RealtimeCallHandler } = await import("./realtime-handler-BKPu_YVj.js");
