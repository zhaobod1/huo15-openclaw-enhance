...
import "./accounts-Bez10r8d.js";
import "./runtime-api-BZUeN5oX.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Dd9PP4yC.js";
import { t as sendMessageZalo } from "./send-BW8pDhVH.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DKJ35qnG.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-B3LoXbqS.js");
